...
// We use the real Microchip interface for bootloader mode
...
typedef struct _INTERFACE_INFO {
	...
	ENDPOINT_INFO Endpoints[1];	// placeholder for array of endpoint info structures
...
typedef struct _CONFIGURATION_INFO {
	...
	INTERFACE_INFO Interfaces[1];	// placeholder for array of interface info structures
...
typedef struct _DEVICE_INFO {
	...
	USHORT idProduct;
	USHORT bcdDevice;
	CONFIGURATION_INFO Configurations[1];	// placeholder for array of configuration info structures
